        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Draft Raperda / Raperkada <?= $cek_nama_panjang_zona->row()->nama_panjang?></h4>
                            ...
                            foreach ($query->result() as $baris):?>
                                ...
                                <tr>
                                    ...
                                    <td ><?php if($baris->nama_perancang=="" || $baris->nama_perancang==null){ ?>
                                            <label for="label" class="label" style="background-color: purple">Belum Ada Perancang</label>
                                        <?php } else { ?>
                                            <label for="label" class="label" style="background-color: green"><?= $baris->nama_perancang; ?></label>
                                        <?php } ?></td>
